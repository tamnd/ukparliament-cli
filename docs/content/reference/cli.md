...
```
ukparliament <command> [arguments] [flags]
```

Run `ukparliament <command> --help` for the full flag list on any command. This
...
per operation you declare in `ukparliament/domain.go`.
