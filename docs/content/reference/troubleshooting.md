...
Most of these come down to network reality or how ukparliament serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ukparliament rate-limits like any public site. ukparliament already paces
...
Where a surface is gated, ukparliament reads a cookie or token you supply
...
`ukparliament`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ukparliament actually did
