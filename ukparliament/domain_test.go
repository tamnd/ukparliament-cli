...
// HTTP behaviour is covered in ukparliament_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "ukparliament://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("ukparliament", "about")
	if err != nil || got.String() != "ukparliament://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want ukparliament://page/about", got.String(), err)
	}
}
